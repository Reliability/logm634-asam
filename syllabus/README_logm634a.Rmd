...
```{r, echo=FALSE}
week  <- 1:10
chap  <- c('1, 2','2, 3','3, 4','4, 5','5 - 7','8, 9','9, 10','11, 12','12, 13','N/A')
topic <- c('Course Overview<br/>Math/Stat Review<br/>Reliability Introduction<br/>        Distribution Functions',               #1
           'Distribution Functions<br/>Conditional Reliability<br/>Constant Failure Rate Model',          #2
           'Constant Failure Rate Model<br/>Time Dependent Failure Models',        #3
           'Time Dependent Failure Models<br/>Reliability of Systems',               #4
           'Reliability of Systems<br/>State Dependent Systems<br/>Physical Reliability Models',          #5
           'Design for Reliability<br/>Maintainability',                      #6
           'Maintainability<br/>Design for Maintainability',           #7
           'Data Collection<br/>Reliability Testing',                  #8
           'Reliability Testing<br/>Reliability Growth Testing<br/>Review For Final',                     #9
           'Student Presentations<br/>Final Exam')                           #10
